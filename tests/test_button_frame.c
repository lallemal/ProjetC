...
int main(int argc, char** argv)
{
        ...
        //button1 = relief relevé, texte et y plus grand que la frame
        ei_widget_t*	button1;
        ...
        //frame1 = relief relevé, texte et y négatif
        ei_widget_t*    frame1;
        ...
        //button2 = relief baissé, image plus grande que la frame et x plus grand que le parent
        ei_widget_t*	button2;
        ...
        //frame2 = relief baissé, image plus grande que la frame et y négatif
        ei_widget_t*    frame2;
        ...
        //button3 = pas de relief, image plus petite que la frame, rayon des arrondis nul et x négatif
        ei_widget_t*	button3;
        ...
        //frame3 = pas de relief, image plus petite que la frame, x et y négatifs
        ei_widget_t*    frame3;
